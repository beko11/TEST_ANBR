...
if matches[1] == 'clean deleted' or matches[1] =='طرد المحذوف' and is_owner(msg) and msg.to.type == "channel" then 
...
tdcli.getUser(v.user_id_, clean_cb, nil)
    ...
    tdcli.sendMessage(msg.to.id, msg.id, 1, '_📌¦ تم طرد جميع الحسابات المحذوفه._', 1, 'md') 
  end 
